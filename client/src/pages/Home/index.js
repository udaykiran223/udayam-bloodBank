  ...
  return (
    <div>
      ...
      {currentUser.userType === "donar" && (
        <div className="">
          <span className="text-xl text-gray-700 font-semibold mt-" >Your Recent Donations</span>
        <InventoryTable
          filters={{
      ...
      {currentUser.userType === "hospital" && (
        <div className="">
          <span className="text-xl text-gray-700 font-semibold mt-" >Your Recent Requests / Consumptions</span>
        <InventoryTable
          filters={{
